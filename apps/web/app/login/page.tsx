        ...
        <div className="ll">
          ...
          <div className="ll-inner">
            ...
            <h1 style={{ fontSize: 32, fontWeight: 600, letterSpacing: -0.7, lineHeight: 1.1, marginBottom: 10 }}>
              Tus finanzas,<br/>
              <span style={{ color: C.tealDark }}>en un solo lugar.</span>
            </h1>
            ...
            <div style={{ marginBottom: 14 }}>
              <label style={{ display: "block", fontSize: 12.5, fontWeight: 500, color: C.mid, marginBottom: 6 }}>
                Correo electrónico
              </label>
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: C.lo, display: "flex", pointerEvents: "none" }}>
                ...
                <input
                  type="email" placeholder="tu@ejemplo.com"
                  value={email} onChange={e => setEmail(e.target.value)}
                  onFocus={() => setFE(true)} onBlur={() => setFE(false)}
                  autoFocus
                  style={{
                    width: "100%", padding: "11px 12px 11px 38px",
                    background: C.white, border: `1.5px solid ${focusEmail ? C.teal : C.border}`,
                    borderRadius: 10, fontSize: 14, color: C.text, outline: "none",
                    boxShadow: focusEmail ? `0 0 0 3px ${C.teal}1a` : "none",
            ...
            <div style={{ marginBottom: 0 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <span style={{ fontSize: 12, color: C.tealDark, fontWeight: 500, cursor: "default" }}>¿Olvidaste?</span>
              </div>
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: C.lo, display: "flex", pointerEvents: "none" }}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                <input
                  ...
                  style={{
                    width: "100%", padding: "11px 12px 11px 38px",
                    background: C.white, border: `1.5px solid ${focusPass ? C.teal : C.border}`,
                    borderRadius: 10, fontSize: 14, color: C.text, outline: "none",
                    boxShadow: focusPass ? `0 0 0 3px ${C.teal}1a` : "none",
                    transition: "border-color .15s, box-shadow .15s",
                  }}
                />
              </div>
            ...
            <button
              ...
              style={{
                ...
                fontSize: 14, fontWeight: 500, fontFamily: C.font, cursor: "pointer",
            ...
            {/* SECURITY */}
            <div style={{ marginTop: 14, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, fontSize: 12, color: C.lo }}>
